<div id="header">
	...
	<div style="display:none" id="header">
       <div style="display:none" id="search_wrapper">
		...
		<a style="display:none" href='{$mobileurl}/submit' class='submit'>submit</a>
    </div>
    ...
    <div style="text-align:center">
        <div id="pagination" class="flip">
            ...
            {/if}-->
            {if $tnp ne ""}
         	<a id="jump_next" class='pagebuttons' href="{$mobileurl}/vote?page={$tnp}">Xem tiếp. Còn nhiều lắm</a>	
            {else}
