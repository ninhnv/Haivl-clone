    ...
    <div class="signup-wrapper">
        ...
        <div class="content">
            <div class="description">
                <h2>{$lang91}</h2>
                <div style="display:none" class="spcl-button-wrap">
                	<a class="spcl-button facebook badge-facebook-connect" label="LoginFormFacebookButton" next="" href="https://www.facebook.com/dialog/permissions.request?app_id={$FACEBOOK_APP_ID}&display=page&next={$baseurl}/&response_type=code&fbconnect=1&perms=email,user_birthday,user_about_me">{$lang25}</a>
                </div>
                <p class="message"> </p>
            </div>
