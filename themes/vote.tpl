                        ...
                        <div style="position:relative;width:220px;float:right">
                            <div class="info scriptolution-stop" id="action-{$posts[i].PID}">
                                ...
                                <p>
									...
									<!--<div class="fb-like" data-href="{$baseurl}/photo/{$posts[i].PID}" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false" data-width="auto"></div>-->
                                ...
                                <a style="display:none" style="margin-top: 10px;" class="report" entryId="{$posts[i].PID}" href="javascript:void(0);">{$lang146}</a>
                            </div>
                        </div>
                    </li>
                    {/section}                
