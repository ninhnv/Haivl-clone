{if $p.nsfw eq "1" AND $smarty.session.USERID eq ""}
	<div>
        <div class="post-next-prev">
            {if $prev != ""}
            <a id="prev_post" class="prev-post" href="{$baseurl}/photo/{$prev}" onclick="_gaq.push(['_trackEvent', 'View-Post', 'Clicked', 'Previous', 1]);"></a>
            {else}
            <a id="prev_post" class="prev-post" href="{$baseurl}/random" onclick="_gaq.push(['_trackEvent', 'View-Post', 'Clicked', 'Previous', 1]);"></a>
            {/if}
            {if $next ne ""}
            <a id="next_post" class="next-post" href="{$baseurl}/photo/{$next}" onclick="_gaq.push(['_trackEvent', 'View-Post', 'Clicked', 'Next', 1]);"></a>
            {else}
        ...
        <div id="content-holder">
            <div class="post-info-pad">
                ...
                <p>
                    ...
                    <span class="comment"><fb:comments-count href="{$baseurl}/photo/{$p.PID}"></fb:comments-count></span>
            ...
            <div id="post-control-bar" class="spread-bar-wrap">
                <div class="spread-bar">
                    <div class="twitter-btn"><a href="https://twitter.com/share" class="twitter-share-button" data-text="{$p.title}" data-url="{$baseurl}/photo/{$p.PID}" data-count="horizontal" data-via="">&nbsp;</a> </div>
                    <div style="display:none" class="facebook-btn"><fb:like href="{$baseurl}/photo/{$p.PID}?ref=fb" send="false" layout="button_count" width="90px" show_faces="false" font="" label="Post"></fb:like> </div>
					<div class="facebook-btn"><div class="fb-like" data-href="{$baseurl}/photo/{$p.PID}" data-layout="button_count" data-action="like" data-show-faces="true" data-share="true"></div></div>
                    ...
                    {else}
                    <div class="google-btn"><g:plusone size="medium" href="{$baseurl}/photo/{$p.PID}"></g:plusone> </div>
                    {/if}
                    <div style="display:none" class="stumbleupon-btn"><su:badge layout="1" location="{$baseurl}/photo/{$p.PID}?ref=stumbleupon"></su:badge> {literal}<script type="text/javascript"> (function() { var li = document.createElement('script'); li.type = 'text/javascript'; li.async = true;  li.src = 'https://platform.stumbleupon.com/1/widgets.js';  var s = document.getElementsByTagName('script')[0]; s.parentNode.insertBefore(li, s);  })(); </script>{/literal}</div>
                </div>
                <div class="post-next-prev">
                	{if $prev != ""}
                	<a id="prev_post" class="prev-post" href="{$baseurl}/photo/{$prev}" onclick="_gaq.push(['_trackEvent', 'View-Post', 'Clicked', 'Previous', 1]);"></a>
            ...
            <div id="content">
                ...
                <div class="comment-section">
                    ...
                    <div style="margin-left:10px">
                    	<fb:comments href="{$baseurl}/photo/{$p.PID}" num_posts="10" width="700"></fb:comments>				
                    </div>
                    <div id="fb-root"></div>                
                </div>
            	<br/>
                ...
                <div class="post-may-like">
                    <div id="entries-content" class="grid">  
                        ...
                        <ul id="grid-col-{if $smarty.section.i.iteration GT 3}2{else}1{/if}" class="col-{if $smarty.section.i.iteration GT 3}{math equation="x - 3" x=$smarty.section.i.iteration}{else}{$smarty.section.i.iteration}{/if}">
                            <li class=" ">
                                <a href="{$baseurl}/photo/{$r[i].PID}" class="jump_stop">
