            ...
            <div class="content">
                <div class="post-container">
                    <div class="img-wrap">
                    	...
                    	<div id="fb-like" class="_social facebook"><fb:like class=" fb_edge_widget_with_comment fb_iframe_widget" href="{$baseurl}/photo/{$p.PID}?ref=fb" send="false" layout="button_count" width="90px" show_faces="false" font="" label="Fast"></fb:like></div>
...
<div style="position:fixed;top:0px;right:0px;z-index:9999;background-color:;width:390px;height:2910px">
    ...
    <div id="fb-com">
    	<fb:comments colorscheme="dark" width="380" num_posts="5" href="{$baseurl}/photo/{$p.PID}"></fb:comments>
    </div>
</div>
...
$('#fb-com').html('<fb:comments colorscheme="dark" width="380" num_posts="5" href="'+base+'/photo/'+obj.PID+'"></fb:comments>');
$('#fb-like').html('<fb:like class=" fb_edge_widget_with_comment fb_iframe_widget" href="'+base+'/photo/'+obj.PID+'?ref=fb" send="false" layout="button_count" width="90px" show_faces="false" font="" label="Fast"></fb:like>');
...
var url='{/literal}{$baseurl}{literal}/photo/'+pid;
