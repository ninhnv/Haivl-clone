...
<div class="signup-wrapper">
    ...
    <div class="content">
        <div id="signup-desc" class="description">
            <h2>Tạo tài khoản HoyVl</h2><!-- {$lang12} -->
            <h3 style="display:none">{$lang9}<br/>{$lang13}.</h3>
            <div class="spcl-button-wrap">
            	<a style="display:none" class="spcl-button facebook badge-facebook-connect" label="LoginFormFacebookButton" next="" href="https://www.facebook.com/dialog/permissions.request?app_id={$FACEBOOK_APP_ID}&display=page&next={$baseurl}/&response_type=code&fbconnect=1&perms=email,user_birthday,user_about_me">{$lang14}</a>
            ...
            <p class="message">
                {$lang15}<br/>
                <a style="display:none" id="no-facebook-account" href="javascript:void(0);">{$lang16}</a>.
            </p>
        </div>
