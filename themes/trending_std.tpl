    ...
    <div id="content-holder">        
        ...
        <div id="content" listPage="hot">        
                    ...
                    <li class=" gag-link" data-url="{$baseurl}/photo/{$posts[i].PID}" data-text="{$posts[i].story|stripslashes}" gagId="{$posts[i].PID}" itemType="list" id="entry-{$posts[i].PID}">
                        ...
                        <div style="position:relative;width:220px;float:right">
                            <div class="info scriptolution-stop" id="action-{$posts[i].PID}">
                                <h1><a target="_blank" href="{$baseurl}/photo/{$posts[i].PID}" class="jump_focus">{$posts[i].story|stripslashes|mb_truncate:20:"...":'UTF-8'}</a></h1>
                                <h4>
                                ...
                                <a style="display:none"  style="padding-top:10px" class="report" entryId="{$posts[i].PID}" href="javascript:void(0);">{$lang146}</a>
                            </div>
                        </div>
                    </li>
                    {/section}                
            ...
            <div id="paging-buttons" class="paging-buttons">
                {if $tnp ne ""}
                <a style="width: 720px;" href="{$baseurl}/trending?page={$tnp}" class="older">Xem tiếp. Còn nhiều lắm</a>
                {else}
