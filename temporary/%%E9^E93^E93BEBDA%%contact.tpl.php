<?php /* Smarty version 2.6.6, created on 2014-10-24 06:20:20
         compiled from contact.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'contact.tpl', 38, false),)), $this); ?>
...
<div id="main" class="middle">
				<h3 style="font-size:17px;margin: 0 0 5px;">Thông tin liên hệ</h3>
				<p style="font-size:12px">Các ý kiến đóng góp, báo lỗi, yêu cầu, hay những thông tin khác vui lòng gửi email tới: <a href="#">hoyvl.net@gmail.com</a></p>
				<h3 style="font-size:17px;margin: 0 0 5px;">Các kênh thông tin chính thức</h3>
				<p style="font-size:12px">Facebook fan page: <a href="https://www.facebook.com/pages/Hoyvl/829623453725688">Hoyvl</a> </p>
    <div id="content-holder">
        <div class="scriptolution-soft-box static" >
            <div class="content contact-container contact-wrapper">
                <form style="display:none" id="cntctfrm" class="modal" action="<?php echo $this->_tpl_vars['baseurl']; ?>
