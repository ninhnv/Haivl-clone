<?php /* Smarty version 2.6.6, created on 2014-10-22 13:51:25
         compiled from posts_bit_more.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'posts_bit_more.tpl', 3, false),array('modifier', 'mb_truncate', 'posts_bit_more.tpl', 3, false),array('insert', 'return_youtube3', 'posts_bit_more.tpl', 15, false),array('insert', 'return_fod2', 'posts_bit_more.tpl', 19, false),array('insert', 'get_time_to_days_ago', 'posts_bit_more.tpl', 33, false),array('insert', 'get_fav_count', 'posts_bit_more.tpl', 39, false),array('insert', 'get_fav_status', 'posts_bit_more.tpl', 49, false),)), $this); ?>
...
echo smarty_core_run_insert_handler(array('args' => array('name' => 'get_fav_status', 'value' => 'var', 'assign' => 'isfav', 'PID' => $this->_tpl_vars['posts'][$this->_sections['i']['index']]['PID'])), $this); ?>
                                        ...
                                        <a class="vote<?php echo $this->_tpl_vars['page']; ?>
 love <?php if ($this->_tpl_vars['isfav'] == '1'): ?>loved<?php endif; ?>" id="post_love_<?php echo $this->_tpl_vars['posts'][$this->_sections['i']['index']]['PID']; ?>
" rel="<?php echo $this->_tpl_vars['posts'][$this->_sections['i']['index']]['PID']; ?>
" href="javascript:void(0);"><span><?php echo $this->_tpl_vars['lang144']; ?>
</span></a>
                                        <?php else: ?>
                                    	<a class="vote<?php echo $this->_tpl_vars['page']; ?>
 love " id="post_love_<?php echo $this->_tpl_vars['posts'][$this->_sections['i']['index']]['PID']; ?>
" rel="<?php echo $this->_tpl_vars['posts'][$this->_sections['i']['index']]['PID']; ?>
...
"><?php echo $this->_tpl_vars['lang142']; ?>
                    ...
                    $(\'.vote';  echo $this->_tpl_vars['page'];  echo '\').click(function(){
