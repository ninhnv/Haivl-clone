<?php /* Smarty version 2.6.6, created on 2014-10-24 14:09:31
         compiled from trending_std.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'stripslashes', 'trending_std.tpl', 31, false),array('modifier', 'mb_truncate', 'trending_std.tpl', 58, false),array('insert', 'return_youtube3', 'trending_std.tpl', 43, false),array('insert', 'return_fod2', 'trending_std.tpl', 47, false),array('insert', 'get_time_to_days_ago', 'trending_std.tpl', 61, false),array('insert', 'get_fav_count', 'trending_std.tpl', 67, false),array('insert', 'get_fav_status', 'trending_std.tpl', 75, false),array('insert', 'get_unfav_status', 'trending_std.tpl', 84, false),)), $this); ?>
<div id="main">
...
" score="0"><?php echo $this->_tpl_vars['fcount']; ?>
									...
									<div style="display:none"; class="fb-like" data-href="<?php echo $this->_tpl_vars['baseurl']; ?>
/photo/<?php echo $this->_tpl_vars['posts'][$this->_sections['i']['index']]['PID']; ?>
...
"><?php echo $this->_tpl_vars['lang142']; ?>
                                ...
                                <a style="display:none"  style="padding-top:10px" class="report" entryId="<?php echo $this->_tpl_vars['posts'][$this->_sections['i']['index']]['PID']; ?>
